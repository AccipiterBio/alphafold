...
from alphafold.data.gcp_cache import preload_multimer_cached_msas, upload_multimer_zipped_msa
...
flags.DEFINE_boolean('calc_only_features', False, 'Calculate only the features dict '
                     'from MSAs. Use this to spread the computation between cpu and'
                     'and gpu nodes')
FLAGS = flags.FLAGS
...
def main(argv):
  ...
  for i, fasta_path in enumerate(FLAGS.fasta_paths):
	...
	calc_only_features=FLAGS.calc_only_features)
